module SongsHelper
  ...
  def lyric_line_far_from_blank?(line_num, lines)
    ...
    # if a blank line is less than 5 lines away in either direction, this line is too close to a blank
    !(line_type_in_range?(line_num, "blank", 4, lines) || line_type_in_range?(line_num, "blank", -4, lines))
  end
